      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
          ...
          <div className="relative group overflow-hidden rounded-[2rem] bg-neutral-900 border border-white/10 min-h-[320px] sm:min-h-[400px] flex items-center p-8 sm:p-12">
            {/* Background elements */}
            <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-amber-500/10 rounded-full blur-[80px] -translate-y-1/2 translate-x-1/2 group-hover:bg-amber-500/20 transition-colors duration-700" />
            <div className="absolute inset-0 bg-[url('/noise.svg')] opacity-20 mix-blend-overlay" />
            
            {/* Content */}
            <div className="relative z-10 max-w-sm">
              <span className="inline-block px-3 py-1 rounded-full bg-amber-500/20 text-amber-400 font-bold uppercase tracking-widest text-xs mb-4 border border-amber-500/30">
                Combo Deal
              </span>
              <h3 className="text-4xl sm:text-5xl font-black text-white leading-[1.1] mb-4">
                Super <br />
                <span className="text-amber-400">Delicious</span>
              </h3>
              ...
              <Link
                href="/menu"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-amber-500 text-neutral-950 font-bold uppercase tracking-widest hover:bg-amber-400 active:scale-95 transition-all shadow-lg shadow-amber-500/20"
              >
                Order Now
            ...
            <div className="absolute right-[-10%] bottom-[-10%] w-[60%] h-[80%] flex items-center justify-center opacity-30 mix-blend-luminosity group-hover:opacity-100 group-hover:mix-blend-normal transform group-hover:-translate-y-4 group-hover:scale-105 transition-all duration-700 pointer-events-none">
               ...
               <div className="w-64 h-64 bg-amber-500/20 rounded-full blur-3xl absolute" />
               <Flame className="w-32 h-32 text-amber-500/80 drop-shadow-2xl relative z-10" />
            </div>
          </div>
