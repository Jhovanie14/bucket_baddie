...
export const sauces: Sauce[] = [
  {
    ...
    image: "/sauces/ghost-mode-mirchi.png",
    ingredients: [
      "Ghost Pepper",
      "Green Mirchi",
      "Vinegar",
  ...
  },
  {
    ...
    image: "/sauces/periperi-masala.png",
    ingredients: [
      "Peri Peri Chili",
      "Masala Spices",
      "Tomato",
  ...
  // },
  {
    ...
    image: "/sauces/butter-baddie.png",
  ...
  },
  {
    ...
    image: "/sauces/lemon-masalaflex.png",
    ingredients: [
      "Lemon Zest",
      "Chaat Masala",
      "Cumin",
  ...
  },
  {
    ...
    tagline: "Fresh, herby, and packed with flavor.",
    description:
      "A vibrant chutney made with fresh mint and cilantro, balanced with a hint of spice. Perfect for dipping and adding a burst of freshness.",
    heat: 1,
    color: "from-green-400 to-emerald-600",
    image: "/sauces/chutney.png",
    ingredients: ["Mint", "Cilantro", "Green Chilies", "Lime", "Garlic"],
    pairsWith: ["Wings", "Tenders", "Fries-Only Bucket"],
  },
  {
    id: "creamy-garlic",
    name: "Creamy Garlic Parmesan",
    tagline: "Rich, creamy, and packed with garlic goodness.",
    description:
      "A velvety garlic sauce with a hint of Parmesan and a silky finish. No heat, all comfort. The sauce that makes everything better.",
    heat: 1,
    color: "from-yellow-300 to-amber-300",
    image: "/sauces/creamy-garlic.png",
    ingredients: ["Garlic", "Parmesan", "Cream", "Butter", "Salt"],
    pairsWith: ["Tenders", "Buckets", "Loaded Fries"],
  },
  {
    id: "ranch-drip",
    name: "Ranch Drip",
    tagline: "Classic ranch, but make it drip.",
    description:
      "A creamy ranch sauce with a glossy drip finish. Rich, tangy, and completely addictive.",
    heat: 1,
    color: "from-green-300 to-emerald-500",
    image: "/sauces/ranch.png",
    ingredients: ["Mayonnaise", "Buttermilk", "Garlic", "Onion", "Lemon"],
    pairsWith: ["Tenders", "Buckets", "Loaded Fries"],
  },
];
