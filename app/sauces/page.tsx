...
export default async function SaucesPage() {
    ...
    return (
        <section className="min-h-screen pb-24">
            {/* Sauces Hero Header */}
            <div className="relative w-full h-80 md:h-[400px] flex flex-col items-center justify-center text-center px-4 overflow-hidden mb-8 sm:mb-16">
                ...
                <div className="absolute top-1/2 right-1/4 -translate-y-1/2 w-96 h-96 bg-amber-500/20 rounded-full blur-[100px] mix-blend-screen animate-pulse" style={{ animationDelay: '1s' }} />
                ...
                <div className="relative z-20 space-y-6 max-w-4xl mx-auto pt-16">
                    ...
                    <h1 className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black text-white tracking-tight leading-[1.1]">
                        Find Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-400 via-red-500 to-blue-500">Perfect Drip.</span>
                    </h1>
