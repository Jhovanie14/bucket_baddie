    ...
    return (
        <div className="min-h-screen bg-neutral-950 pb-24">
            ...
            <div className="relative w-full h-80 flex flex-col items-center justify-center text-center px-4 overflow-hidden mb-12 sm:mb-20">
                ...
                {/* Animated Glow */}
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[300px] bg-amber-500/20 rounded-full blur-[120px] mix-blend-screen pointer-events-none" />
                ...
                <div className="relative z-20 space-y-6 max-w-3xl mx-auto pt-16">
                    ...
                    <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black text-white tracking-tight leading-[1.1]">
                        Find Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-amber-600">Bucket.</span>
                    </h1>
